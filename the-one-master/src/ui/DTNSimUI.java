...
public abstract class DTNSimUI {
	...
	private void initModel() {
		...
		try {
			...
			String routerName = new Settings(GROUP_NS).getSetting(ROUTER_S);
			System.out.println(routerName);
			if (routerName.equals("IWDMLRouter") || routerName.equals(("MLProph")))
				MLTrainer.train_data();
		    ...
		    System.err.println("Couldn't train data");
			e.printStackTrace();
		}
	}
